    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_GEMINI_BASE_URL: data.CLAUDE_MEM_GEMINI_BASE_URL || DEFAULT_SETTINGS.CLAUDE_MEM_GEMINI_BASE_URL,
          ...
          CLAUDE_MEM_OPENAI_SITE_URL: data.CLAUDE_MEM_OPENAI_SITE_URL || DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_SITE_URL,
          CLAUDE_MEM_OPENAI_APP_NAME: data.CLAUDE_MEM_OPENAI_APP_NAME || DEFAULT_SETTINGS.CLAUDE_MEM_OPENAI_APP_NAME,
